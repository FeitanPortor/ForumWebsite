        ...
        <div class="row align-items-center">
            <div class="col-md-12 mb-3 mb-sm-0">
                ...
                <p class="text-sm"><span class="op-6">Posted</span> <a class="text-black"
                        href="#"><?php echo $single->created_at; ?> by</span> <a class="text-black"
                            href="#"><?php echo $single->post_author; ?></a></p>
                <div class="text-sm op-5"> <a class="text-black mr-2" href="#"><?php echo $single->category; ?></a>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3 mb-sm-0">
                ...
                <form method="POST" action="single.php?id=1">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="replay" id="exampleFormControlTextarea1"
                            rows="3"></textarea>
                    </div>

                    <div class="form-group">
                        <input type="hidden" name="post_id" value="<?php echo $id; ?>" class="form-control"
                            id="exampleFormControlInput1" placeholder="author name">
                    </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-12 mb-3 mb-sm-0">
                ...
                <p class="text-sm"><span class="op-6">Commented</span> <a class="text-black"
                        href="#"><?php echo $singleReplay->created_at; ?></a> </p>
            </div>
